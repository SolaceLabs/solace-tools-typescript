...
let ConsumerCreatedCredentialSet_1: CredentialsRequest = {
...
let ConsumerCreatedCredentialSet_2: CredentialsRequest = {
...
describe(`${scriptName}`, () => {
  ...
  it(`${scriptName}: should create new app registration`, async () => {
    try {
      ...
      const applicationRegistrationView: ApplicationRegistrationView = applicationRegistrationResponse.data;
      expect(applicationRegistrationView.credentials.length, TestLogger.createApiTestFailMessage('no credentials returned')).to.equal(1);
