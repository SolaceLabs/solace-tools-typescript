...
const initializeGlobals = () => {
  AsyncApiSpecFile = TestService.validateFilePathWithReadPermission(`${TestConfig.getConfig().dataRootDir}/passing/misc/simple-api-two-domains.spec.yml`);
  // set test specific importer options
  CliConfig.getCliImporterManagerOptions().asyncApiFileList = [AsyncApiSpecFile];
...
TODO: delete app domains from spec first
