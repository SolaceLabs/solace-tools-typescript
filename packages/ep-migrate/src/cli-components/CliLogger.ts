...
export enum ECliStatusCodes {
  ...
  MIGRATE_SUMMARY_LOG = "MIGRATE_SUMMARY_LOG",
  MIGRATE_SUMMARY_STATS = "MIGRATE_SUMMARY_STATS",
  MIGRATE_ISSUE = "MIGRATE_ISSUE",
...
export enum ECliSummaryStatusCodes {
  ...
  PRESENT_EP_V2_ENUM = "PRESENT_EP_V2_ENUM",
  PROCESSING_EP_V1_ENUM_ISSUE = "PROCESSING_EP_V1_ENUM_ISSUE",
  PRESENT_EP_V2_ENUM_VERSION = "PRESENT_EP_V2_ENUM_VERSION",
