...
const EventApiInfoList: Array<TEventApiInfo> = [
  {
    eventApiName: "_event_api_name_0_",
    versionInfoList: [{ versionString: "1.0.0" }, { versionString: "1.1.0" }],
  },
  {
    eventApiName: "_event_api_name_1_",
    versionInfoList: [{ versionString: "1.0.0" }, { versionString: "1.1.0" }],
  },
  {
    eventApiName: "_event_api_name_2_",
    versionInfoList: [{ versionString: "1.0.0" }, { versionString: "1.1.0" }],
  },
];

const getLatestVersionInfoFromList = (
  versionInfoList: Array<TVersionInfo>
): TVersionInfo | undefined => {
  ...
  for (const versionInfo of versionInfoList) {
    if (versionInfo.versionString === undefined)
      throw new Error(`${logName}: versionInfo.versionString === undefined`);
    if (versionInfo.versionId === undefined)
      throw new Error(`${logName}: versionInfo.versionId === undefined`);
    const newVersionString: string = versionInfo.versionString;
    if (
      EpSdkSemVerUtils.is_NewVersion_GreaterThan_OldVersion({
