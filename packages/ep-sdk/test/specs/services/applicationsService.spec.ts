...
describe(`${scriptName}`, () => {
  ...
  after(async() => {
    TestContext.newItId();
    let xvoid: void = await TestHelpers.applicationDomainAbsent({ applicationDomainName: ApplicationDomainName });
    ...
    xvoid = await EpSdkApplicationsService.removeAssociatedEntityTypeFromCustomAttributeDefinitions({
