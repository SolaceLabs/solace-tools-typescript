...
export class TestHelpers {
  ...
  public static createEventVersion = async({ applicationDomainId, stateId }:{
    ...
    if(schemaResponse.data.id === undefined) throw new EpSdkApiContentError(logName, this.constructor.name, 'schemaResponse.data.id === undefined', {
      schemaResponse: schemaResponse
    });
    ...
    if(eventResponse.data.id === undefined) throw new EpSdkApiContentError(logName, this.constructor.name, 'eventResponse.data.id === undefined', {
      eventResponse: eventResponse
    });
