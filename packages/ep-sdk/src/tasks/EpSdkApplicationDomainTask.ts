...
import { EpSdkApplicationDomainsService } from "../services";
import {
  EpSdkTask,
  IEpSdkTask_Config,
...
type TEpSdkApplicationDomainTask_Settings = Partial<
  Pick<
    ApplicationDomain,
  ...
  >
>;
type TEpSdkApplicationDomainTask_CompareObject =
  TEpSdkApplicationDomainTask_Settings;
...
/** @category Tasks */
export interface IEpSdkApplicationDomainTask_GetFuncReturn
  extends Omit<IEpSdkTask_GetFuncReturn, "epObject"> {
  epObject: ApplicationDomain | undefined;
}
/** @category Tasks */
export interface IEpSdkApplicationDomainTask_CreateFuncReturn
  extends Omit<IEpSdkTask_CreateFuncReturn, "epObject"> {
  epObject: ApplicationDomain;
}
/** @category Tasks */
export interface IEpSdkApplicationDomainTask_UpdateFuncReturn
  extends Omit<IEpSdkTask_UpdateFuncReturn, "epObject"> {
  epObject: ApplicationDomain;
}
/** @category Tasks */
export interface IEpSdkApplicationDomainTask_DeleteFuncReturn
  extends Omit<IEpSdkTask_DeleteFuncReturn, "epObject"> {
  epObject: ApplicationDomain;
}
/** @category Tasks */
export interface IEpSdkApplicationDomainTask_ExecuteReturn
...
export class EpSdkApplicationDomainTask extends EpSdkTask {
  ...
  protected async getFunc(
    epSdkApplicationDomainTask_Keys: IEpSdkApplicationDomainTask_Keys
  ): Promise<IEpSdkApplicationDomainTask_GetFuncReturn> {
    ...
    const applicationDomainName =
      epSdkApplicationDomainTask_Keys.applicationDomainName;
  ...
  protected async isUpdateRequiredFunc(
    epSdkApplicationDomainTask_GetFuncReturn: IEpSdkApplicationDomainTask_GetFuncReturn
    ...
    EpSdkLogger.trace(
      EpSdkLogger.createLogEntry(logName, {
        ...
        module: this.constructor.name,
        details: {
          epSdkApplicationDomainTask_GetFuncReturn:
            epSdkApplicationDomainTask_GetFuncReturn,
        },
      })
    );

    if (epSdkApplicationDomainTask_GetFuncReturn.epObject === undefined)
      throw new EpSdkInternalTaskError(
        logName,
        this.constructor.name,
        "epSdkApplicationDomainTask_GetFuncReturn.epObject === undefined"
      );

    const existingObject: ApplicationDomain =
    ...
    const existingCompareObject: TEpSdkApplicationDomainTask_CompareObject = {
      ...
      topicDomainEnforcementEnabled:
        existingObject.topicDomainEnforcementEnabled,
      uniqueTopicAddressEnforcementEnabled:
        existingObject.uniqueTopicAddressEnforcementEnabled,
    };
  ...
  protected async createFunc(): Promise<IEpSdkApplicationDomainTask_CreateFuncReturn> {
    ...
    if (applicationDomainResponse.data === undefined)
      throw new EpSdkApiContentError(
        logName,
        this.constructor.name,
        "applicationDomainResponse.data === undefined",
        {
          epSdkApplicationDomainTask_Config: this.getTaskConfig(),
          create: create,
          applicationDomainResponse: applicationDomainResponse,
  ...
  protected async updateFunc(
    epSdkApplicationDomainTask_GetFuncReturn: IEpSdkApplicationDomainTask_GetFuncReturn
  ): Promise<IEpSdkApplicationDomainTask_UpdateFuncReturn> {
    ...
    /* istanbul ignore next */
    if (epSdkApplicationDomainTask_GetFuncReturn.epObject.id === undefined)
      throw new EpSdkApiContentError(
        logName,
        this.constructor.name,
        "epSdkApplicationDomainTask_GetFuncReturn.epObject.id === undefined",
        {
  ...
  protected async deleteFunc(
    epSdkApplicationDomainTask_GetFuncReturn: IEpSdkApplicationDomainTask_GetFuncReturn
  ): Promise<IEpSdkApplicationDomainTask_DeleteFuncReturn> {
