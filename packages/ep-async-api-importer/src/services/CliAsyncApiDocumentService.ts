...
class CliAsyncApiDocumentService {
  ...
  public parse_and_validate = async({ apiFile, applicationDomainName, assetApplicationDomainName, applicationDomainNamePrefix }:{
    apiFile: string;
  ...
  public map_MessageDocumentContentType_To_EpSchemaContentType(messageContentType: E_EpAsyncApiContentTypes): EEpSdkSchemaContentType {
  ...
  public map_MessageDocumentSchemaFormatType_To_EpSchemaFormatType(messageSchemaFormatType: E_EpAsyncApiSchemaFormatType): EEpSdkSchemaType {
    const funcName = 'map_MessageDocumentSchemaFormatType_To_EpSchemaFormatType';
    const logName = `${CliAsyncApiDocumentService.name}.${funcName}()`;
