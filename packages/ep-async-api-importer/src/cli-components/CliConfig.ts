...
class CliConfig {
  ...
  public initialize = ({ defaultAppName, fileList, applicationDomainName, assetApplicationDomainName }: {
    ...
    this.config = {
      ...
      cliImporterConfig: {
        ...
        cliImporterOptions: {
          ...
          cliAssetImport_BrokerType: this.getOptionalEnvVarValueAsString_From_Options_WithDefault(ECliConfigEnvVarNames.CLI_IMPORT_BROKER_TYPE, Object.values(ECliAssetImport_BrokerType) as Array<string>, DEFAULT_CLI_IMPORT_BROKER_TYPE as unknown as string) as unknown as ECliAssetImport_BrokerType,
