...
export enum ECliStatusCodes {
  ...
  SETUP_TEST_DOMAIN_APP_VERSION_COPIED = "SETUP_TEST_DOMAIN_APP_VERSION_COPIED",
  SETUP_TEST_DOMAIN_APP_VERSION_COPY_SKIPPED = "SETUP_TEST_DOMAIN_APP_VERSION_COPY_SKIPPED",
...
export enum ECliSummaryStatusCodes {
  ...
  PROCESSED_EVENT_API = "PROCESSED_EVENT_API",
