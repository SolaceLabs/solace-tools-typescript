...
export abstract class CliAssetsImporter extends CliImporter {
  ...
  private run_present_channel_event = async({ assetApplicationDomainId, epAsyncApiChannelDocument, epAsyncApiMessageDocument, specVersion, schemaVersionId, checkmode }:{
    assetApplicationDomainId: string;
    epAsyncApiChannelDocument: EpAsyncApiChannelDocument;
    epAsyncApiMessageDocument: EpAsyncApiMessageDocument;
    specVersion: string;
  ...
  protected async run_present_assets({ cliAssetsImporterRunPresentOptions }:{
    ...
    const cliAssetsImporterRunPresentReturn: ICliAssetsImporterRunPresentReturn = {
      assetApplicationDomainId: epSdkAssetApplicationDomainTask_ExecuteReturn.epObject.id
    };
