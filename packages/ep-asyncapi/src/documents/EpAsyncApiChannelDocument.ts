...
export class EpAsyncApiChannelDocument {
  ...
  private _validate_EpEventVersionName = (
    epEventVersionName: string
  ): string => {
  ...
  public getAsyncApiChannel(): Channel {
    return this.asyncApiChannel;
  }

  public getAsyncApiChannelKey(): string {
  ...
  public getEpAsyncApiChannelSubscribeOperation(): EpAsyncApiChannelSubscribeOperation | undefined {
    if (this.asyncApiChannel.hasSubscribe()) {
      return new EpAsyncApiChannelSubscribeOperation(
        this.epAsyncApiDocument,
        this,
        this.asyncApiChannel.subscribe()
      );
    }
    return undefined;
  }
