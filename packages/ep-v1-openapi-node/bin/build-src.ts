...
// description
const packageJsonDescription = "Solace Event Portal V1 OpenAPI Client for NodeJS (Typescript)";
// readme version description
const readmeVersionDescription = "Event Portal V1 OpenAPI Version";
